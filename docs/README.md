...
| Consolidação dos guias 06–15 | `AI Engineering Control Plane.md` |
...
| `docs/13-15` | Browser Harness, CLI adapters e des-overengineering | histórico consolidado em `AI Engineering Control Plane.md` |
