...
try { await access("node_modules/.bin/marp"); } catch { process.stdout.write(`${JSON.stringify({ status: "skipped", reason: "Marp CLI is optional until dependencies are installed" })}\n`); process.exit(0); }
...
process.stdout.write(`${JSON.stringify({ status: "built", format, decks: decks.length })}\n`);
